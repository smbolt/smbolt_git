...
Protected Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Dim dataX() As Date = {New DateTime(2008, 7, 1, 0, 0, 0), New DateTime(2008, 7, 1, 2, 17, 2), _
        New DateTime(2008, 7, 1, 8, 5, 30), New DateTime(2008, 7, 1, 10, 54, 10), New DateTime( _
        2008, 7, 1, 15, 40, 0), New DateTime(2008, 7, 1, 18, 22, 20), New DateTime(2008, 7, 1, 22, _
        17, 14), New DateTime(2008, 7, 2, 2, 55, 50), New DateTime(2008, 7, 2, 8, 17, 14), _
        New DateTime(2008, 7, 2, 11, 55, 50), New DateTime(2008, 7, 2, 13, 17, 14), New DateTime( _
        2008, 7, 2, 17, 55, 50), New DateTime(2008, 7, 2, 20, 17, 14), New DateTime(2008, 7, 3, 0, _
        0, 0)}
    ...
    ' vertical grid lines.
    c.setPlotArea(100, 30, 470, 120, -1, -1, Chart.Transparent).setGridColor(Chart.Transparent, _
        &H888888, Chart.Transparent, c.dashLineColor(&Hcccccc, Chart.DotLine))
