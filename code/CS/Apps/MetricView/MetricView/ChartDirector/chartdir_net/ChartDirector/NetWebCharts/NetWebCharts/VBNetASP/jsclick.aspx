...
Protected Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    ' database.
    '
    Dim revenue() As Double = {4500, 5600, 6300, 8000, 12000, 14000, 16000, 20000, 24000, 28000}
    Dim grossMargin() As Double = {62, 65, 63, 60, 55, 56, 57, 53, 52, 50}
    Dim backLog() As Double = {563, 683, 788, 941, 1334, 1522, 1644, 1905, 2222, 2544}
    ...
    ' (ffffff).
    c.setPlotArea(60, 40, 480, 280, c.linearGradientColor(60, 40, 60, 280, &Heeffee, &H008800), _
        -1, &Hffffff, &Hffffff)
    ...
    Dim showText As String = "onmouseover='showInfo(""{xLabel}"", {value}, {field0}, {field1});' "
