...
Protected Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Dim actualStartDate() As Date = {DateSerial(2004, 8, 16), DateSerial(2004, 8, 27), DateSerial( _
        2004, 9, 9), DateSerial(2004, 9, 18), DateSerial(2004, 9, 22)}
    Dim actualEndDate() As Date = {DateSerial(2004, 8, 27), DateSerial(2004, 9, 9), DateSerial( _
        2004, 9, 27), DateSerial(2004, 10, 2), DateSerial(2004, 10, 8)}
    ...
    Dim actualColor As Integer = c.patternColor(New Integer() {&Hffffff, &Hffffff, &Hffffff, _
        &Hff0000, &Hffffff, &Hffffff, &Hff0000, &Hffffff, &Hffffff, &Hff0000, &Hffffff, &Hffffff, _
        &Hff0000, &Hffffff, &Hffffff, &Hffffff}, 4)

    ' Add a box whisker layer to represent the actual dates. We add the actual dates layer first, so
