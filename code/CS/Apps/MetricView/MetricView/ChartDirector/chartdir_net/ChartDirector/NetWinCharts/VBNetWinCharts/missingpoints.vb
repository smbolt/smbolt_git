...
Public Class missingpoints
    ...
    Public Sub createChart(viewer As WinChartViewer, chartIndex As Integer) _
        ...
        Dim data2() As Double = {Chart.NoValue, Chart.NoValue, 25, 28, 38, 20, 22, Chart.NoValue, _
            25, 33, 30, 24}
        ...
        layer2.addDataSet(data2, &Hff6600, "Proton Cannon").setDataSymbol(Chart.GlassSphere2Shape, _
            11)
