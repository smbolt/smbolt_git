...
Public Class threedbubble
    ...
    Public Sub createChart(viewer As WinChartViewer, chartIndex As Integer) _
        ...
        c.addScatterLayer(dataX0, dataY0, "Technology AAA", Chart.GlassSphereShape, 15, &Hff3333 _
        ...
        c.addScatterLayer(dataX1, dataY1, "Technology BBB", Chart.GlassSphereShape, 15, &H0000ff _
