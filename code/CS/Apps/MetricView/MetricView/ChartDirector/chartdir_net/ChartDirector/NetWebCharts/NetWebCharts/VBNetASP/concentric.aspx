...
Protected Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Dim t As ChartDirector.TextBox = c.addText(260, 300, " Year 2006 ", "Arial Bold Italic", 12, _
        &Hffffff)
    ...
    ' Add a label at the center of the ring to label the inner ring. Use 12pt Arial Bold Italic font
    ' in white (ffffff) color, on a deep blue (0000cc) background, with soft lighting effect and 5
    ' pixels rounded corners
    Dim t2 As ChartDirector.TextBox = c2.addText(110, 110, " Year 2005 ", "Arial Bold Italic", 12, _
        &Hffffff, Chart.Center)
    ...
    WebChartViewer1.ImageMap = c2.getHTMLImageMap("", "", _
        "title='{label} revenue for 2005: US${value}M ({percent}%)'", 50, 90) + c.getHTMLImageMap( _
