...
namespace Teleflora.Operations.MetricView
{
  public class MetricObservationSet : System.Collections.Generic.SortedList<int, MetricObservation>
  {
    ...
    {
      get {
        return _highMetricValue;
      }
      set {
        _highMetricValue = value;
      }
    }
    ...
    {
      get {
        return _lowMetricValue;
      }
      set {
        _lowMetricValue = value;
      }
    }
    ...
    private string GetMachineName(int serverID)
    {
      ...
      {
        case 15:
          machineName = @"\\EPRODADMINWEB1";
          break;
        case 77:
          machineName = @"\\EPRODCCS1";
          break;
        case 22:
          machineName = @"\\EPRODGW1";
          break;
        case 23:
          machineName = @"\\EPRODGW2";
          break;
        case 26:
          machineName = @"\\EPRODMKDG1";
          break;
        case 35:
          machineName = @"\\EPRODSEARS";
          break;
        case 2:
          machineName = @"\\EPRODSQL11";
          break;
        case 3:
          machineName = @"\\EPRODSQL12";
          break;
        case 4:
          machineName = @"\\EPRODSQL13";
          break;
        case 6:
          machineName = @"\\EPRODSQL15";
          break;
        case 75:
          machineName = @"\\EPRODSQL2";
          break;
        case 76:
          machineName = @"\\EPRODSQL3";
          break;
        case 61:
          machineName = @"\\EPRODSQL4";
          break;
        case 62:
          machineName = @"\\EPRODSQL5";
          break;
        case 63:
          machineName = @"\\EPRODSQL6";
          break;
        case 64:
          machineName = @"\\EPRODSQL7";
          break;
        case 65:
          machineName = @"\\EPRODSQL8";
          break;
        case 66:
          machineName = @"\\EPRODSQL9";
          break;
        case 40:
          machineName = @"\\EPRODUSAA";
          break;
        case 41:
          machineName = @"\\EPRODWEB1";
          break;
        case 50:
          machineName = @"\\EPRODWEB10";
          break;
        case 51:
          machineName = @"\\EPRODWEB11";
          break;
        case 52:
          machineName = @"\\EPRODWEB12";
          break;
        case 42:
          machineName = @"\\EPRODWEB2";
          break;
        case 43:
          machineName = @"\\EPRODWEB3";
          break;
        case 44:
          machineName = @"\\EPRODWEB4";
          break;
        case 45:
          machineName = @"\\EPRODWEB5";
          break;
        case 46:
          machineName = @"\\EPRODWEB6";
          break;
        case 47:
          machineName = @"\\EPRODWEB7";
          break;
        case 48:
          machineName = @"\\EPRODWEB8";
          break;
        case 49:
          machineName = @"\\EPRODWEB9";
          break;
      }
      return machineName;
    }
    ...
    private string GetCounterName(int metricID)
    {
      ...
      switch (metricID)
      {
        ...
        case 13:
          ...
          break;
        case 14:
          counterName = @"Connection Attempts/sec";
          break;
        case 15:
