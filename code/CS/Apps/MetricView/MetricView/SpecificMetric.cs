...
namespace Teleflora.Operations.MetricView
{
  ...
  public class SpecificMetric
  {
    ...
    {
      get {
        return _legendLabelNumber;
      }
      set {
        _legendLabelNumber = value;
      }
    }
    ...
    {
      get {
        return _isMetricFromFile;
      }
      set {
        _isMetricFromFile = value;
      }
    }
    ...
    {
      get {
        return _metricFileName;
      }
      set {
        _metricFileName = value;
      }
    }
    ...
    {
      get {
        return _rollUpToHourly;
      }
      set {
        _rollUpToHourly = value;
      }
    }
