...
namespace Org.OpsManager
{
  public partial class frmScheduledTask : Form
  {
    ...
    private void SaveToDb()
    {
      ...
      _opsData.CurrentScheduledTask.AssemblyName = txtAssemblyName.Text.GetStringValueOrNull();
      _opsData.CurrentScheduledTask.CatalogName = txtCatalogName.Text.GetStringValueOrNull();
      _opsData.CurrentScheduledTask.CatalogEntry = txtCatalogEntry.Text.GetStringValueOrNull();
      _opsData.CurrentScheduledTask.ObjectTypeName = txtObjectTypeName.Text.GetStringValueOrNull();
    ...
    private void SetScheduledTaskData()
    {
      try
      {
        ...
        txtAssemblyName.Text = _opsData.CurrentScheduledTask.AssemblyName;
        txtCatalogName.Text = _opsData.CurrentScheduledTask.CatalogName;
        txtCatalogEntry.Text = _opsData.CurrentScheduledTask.CatalogEntry;
        txtObjectTypeName.Text = _opsData.CurrentScheduledTask.ObjectTypeName;
    ...
    private void CheckforChanges()
    {
      ...
      if (txtTaskName.Text.Trim() != _opsData.CurrentScheduledTask.TaskName ||
          ...
          txtAssemblyName.Text.GetStringValueOrNull() != _opsData.CurrentScheduledTask.AssemblyName ||
          txtCatalogName.Text.GetStringValueOrNull() != _opsData.CurrentScheduledTask.CatalogName ||
          txtCatalogEntry.Text.GetStringValueOrNull() != _opsData.CurrentScheduledTask.CatalogEntry ||
          txtObjectTypeName.Text.GetStringValueOrNull() != _opsData.CurrentScheduledTask.ObjectTypeName ||
