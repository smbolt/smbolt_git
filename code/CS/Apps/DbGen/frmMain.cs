...
namespace Org.DbGen
{
  public partial class frmMain : Form
  {
    ...
    private void InitializeForm()
    {
      ...
      string repositoryPath = g.CI("RepositoryPath");
      string majorSection = g.CI("RepositoryMajorSection");
      string classPath = repositoryPath + @"\" + majorSection + @"\GS\Database\DB_CLASSES.cs";
