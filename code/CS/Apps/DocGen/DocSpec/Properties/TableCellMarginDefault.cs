...
{
    [Meta(OxName = "tblCellMarDflt", Abbr = "TCMgnDflt")]
    public class TableCellMarginDefault : DocumentElement
    {
        [Meta(XMatch = true)]
        ...
        [Meta(XMatch = true)]
        public Margin TableCellLeftMargin { get; set; }
        [Meta(XMatch = true)]
        public Margin TableCellRightMargin { get; set; }
        [Meta(XMatch = true)]
        public Margin StartMargin { get; set; }
        [Meta(XMatch = true)]
        public Margin EndMargin { get; set; }
        public List<Margin> UsedMargins
        {
            get { return GetUsedMargins(); }
        }


        public PageLayout Area
        {
            get { return this.ComputeArea(); }
        }
        
        public TableCellMarginDefault() { }

        public TableCellMarginDefault(XElement xml, Doc doc, DocumentElement parent)
        {
