...
namespace Org.DocGen.DocSpec
{
  ...
  public class RunFonts : DocumentElement
  {
    ...
    private ThemeFontValues? GetThemeFontValues(string themeFontValue)
    {
      ...
      {
        case "majorEastAsia":
          return ThemeFontValues.MajorEastAsia;
        case "majorBidi":
          return ThemeFontValues.MajorBidi;
        case "majorAscii":
          return ThemeFontValues.MajorAscii;
        case "majorHAnsi":
          return ThemeFontValues.MajorHighAnsi;
        case "minorEastAsia":
          return ThemeFontValues.MinorEastAsia;
        case "minorBidi":
          return ThemeFontValues.MinorBidi;
        case "minorAscii":
          return ThemeFontValues.MinorAscii;
        case "minorHAnsi":
          return ThemeFontValues.MinorHighAnsi;
      }
