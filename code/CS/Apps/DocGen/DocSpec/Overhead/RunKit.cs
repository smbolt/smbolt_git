...
namespace Org.DocGen.DocSpec
{
  public class RunKit
  {
    ...
    public float TextCompressionFactor {
      get;
      set;
    }
    public float StandardSpaceWidth {
      get;
      set;
    }
