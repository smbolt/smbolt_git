...
namespace Org.DocGen.DocSpec
{
  public class Metrics
  {
    ...
    public float WidthSpecUsed {
      get;
      set;
    }
    public float HeightSpecUsed {
      get;
      set;
    }
    public float MaxChildHeightSpec {
      get;
      set;
    }

    public PointF CurrentOffset {
      get {
        return Get_CurrentOffset();
      }
    }
    public PointF CurrentHorizontalOffset {
      get {
        return Get_CurrentHorizontalOffset();
      }
    }
    public PointF CurrentVerticalOffset {
      get {
        return Get_CurrentVerticalOffset();
      }
    }
    public RectangleF UsedRectangle {
      get {
        return Get_UsedRectangle();
      }
    }
    public Doc Doc {
      get;
