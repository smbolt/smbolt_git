...
namespace Org.DocGen.DocSpec
{
    public class DocumentElement
    {
        ...
        public DocumentElement Properties { get; set; }
        public List<DocumentElement> ChildElements { get; set; }

        public AggregatedProperties AggregatedProperties { get; set; }
        public bool PropertiesAreAggregated { get; set; }
        public string Source { get; set; }
        public Metrics RawMetrics { get; set; }    
        public Metrics MappedMetrics { get; set; }     

        private bool _isProperties;
        public bool IsProperties { get { return this._isProperties; }}
        public string OpenXmlClassName { get; set; }
        public bool IsFirst { get { return this.Get_IsFirst(); }}
        public bool IsLast { get { return this.Get_IsLast(); }}
        public bool IsUnique { get { return this.Get_IsUnique(); }}
        public bool IsLeaf { get { return this.Get_IsLeaf(); }}
        public string OxName { get { return Get_OxName(); }}
        public string ParentSet { get { return Get_ParentSet(); }}
        public string ChildOfSet { get { return Get_ChildOfSet(); }}
        public bool IsAutoMappable { get { return Get_AutoMap(); }}
        public string Abbr { get { return Get_Abbr(); }}
        public bool MapAsAttribute { get { return Get_IsAttribute(); }}
        public int Level { get { return Get_Level(); }}
        public virtual string Text { get { return Get_Text(); }}
        public OccupiedRegionSet RegionSet { get; set; }

        private bool _inDiagnosticsMode; 
        public bool InDiagnosticsMode 
        { 
            get { return _inDiagnosticsMode; }
            set { _inDiagnosticsMode = value; }
        }

        public int _diagnosticsLevel;
        public int DiagnosticsLevel
        {
            get { return _diagnosticsLevel; }
            set { _diagnosticsLevel = value; }
        }

        public List<Match> PropertyMatchList { get; set; }
        ...
        public XNode GetXmlMap(bool showProperties)
        {
            ...
            List<string> elementNames = new List<string>() { "Text", "ContentQuery", "ContentValue" };
            if (name == "Text")
            {
            ...
            List<string> propNames = new List<string>() { "Name", "Tag", "Parent", "Level" };
