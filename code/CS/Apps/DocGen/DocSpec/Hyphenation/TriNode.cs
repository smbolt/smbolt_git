...
namespace Org.DocGen.DocSpec
{
    public class TriNode
    {
        ...
        public TriNode Root { get; set; }
        public TriNode Parent { get; set; }
        public TriNode N1_Low { get; set; }
        public TriNode N2_Equal { get; set; }
        public TriNode N3_High { get; set; }
        public char Char { get; set; }
        public int Level { get { return Get_Level(); } }
        public string Value { get { return Get_Value(); } }
        public List<string> Patterns { get; set; }
        public bool HasData { get; set; }
        public bool IsTerminal { get { return Get_IsTerminal(); } }
        public TriNodeType TriNodeType { get { return Get_TriNodeType(); } }
        public string NodeBeingAdded { get; set; }
        public string IncludedLevels { get; set; }
        public string LevelsIncluded { get; set; }
        public string ComputedValue { get; set; }
        public string FullPath { get { return Get_FullPath(); } }
        public int TotalNodeCount { get; set; }
        public int TotalLowNodeCount { get; set; }
        public int TotalEqualNodeCount { get; set; }
        public int TotalHighNodeCount { get; set; }
