...
namespace Org.DocGen.DocSpec
{
  public class SpellingToken
  {
    ...
    public bool BeginOfSentence {
      get;
      set;
    }
    public bool IsSpellingChecked {
      get;
      set;
    }
    ...
    public List<string> SpellingSuggestions {
      get;
      set;
    }

    public bool SpellCheckThisToken {
      get {
        return Get_SpellCheckThisToken();
      }
    }
