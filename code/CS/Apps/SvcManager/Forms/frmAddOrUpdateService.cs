...
{
  public partial class frmAddOrUpdateTaskService : Form
  {
    private bool _isNew;
    ...
    public frmAddOrUpdateTaskService(ServiceEnvironment serviceEnvironment, ServiceHost serviceHost, ServiceType serviceType, ConfigDbSpec dbSpec, bool isNew)
    {
      InitializeComponent();
