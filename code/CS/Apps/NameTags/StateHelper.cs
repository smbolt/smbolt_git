...
namespace NameTags
{
    public static class StateHelper
    {
        ...
        {
            get { return _tagsPerPage; }
            set { _tagsPerPage = value; }
        }
        ...
        {
            get { return _firstTagOnPage; }
            set { _firstTagOnPage = value; }
        }

        private static int _lastTagOnPage;
        public static int LastTagOnPage
        {
            get { return _lastTagOnPage; }
            set { _lastTagOnPage = value; }
        }
    }
}
