...
namespace NameTags
{
    public static class ConfigHelper
    {
        ...
        {
            get { return _defaultLogFileName; }
            set { _defaultLogFileName = value; }
        }
