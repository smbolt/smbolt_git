...
namespace NameTags
{
    ...
    public class PrintPageSettings
    {
        ...
        {
            get { return _pageAlignment; }
            set { _pageAlignment = value; }
        }
        ...
        {
            get { return _printAdjustHorizontal; }
            set { _printAdjustHorizontal = value; }
        }

        private float _printAdjustVertical;
        public float PrintAdjustVertical
        {
            get { return _printAdjustVertical; }
            set { _printAdjustVertical = value; }
        }

        private float _nameTagWidth;
        public float NameTagWidth
        {
            get { return _nameTagWidth; }
            set { _nameTagWidth = value; }
        }

        private float _nameTagHeight;
        public float NameTagHeight
        {
            get { return _nameTagHeight; }
            set { _nameTagHeight = value; }
        }
