...
namespace Org.NotificationTest
{
  public partial class frmMain : Form
  {
    ...
    private void Action(object sender, EventArgs e)
    {
      ...
      {
        case "ReloadConfigs":
          var notifyConfigMode = ckFromDatabase.Checked ? NotifyConfigMode.FromDatabase : NotifyConfigMode.FromAppConfig;
    ...
    private void InitializeForm()
    {
      try
      {
        ...
        _notifyConfigMode = g.ToEnum<NotifyConfigMode>(g.CI("NotifyConfigMode"), NotifyConfigMode.FromAppConfig);
