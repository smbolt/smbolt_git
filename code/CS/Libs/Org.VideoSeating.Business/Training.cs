...
namespace Org.VideoSeating.Business
{
  ...
  public class Training
  {
    ...
    public int ChartWidth {
      get {
        return (this.Columns * _seatSpotSize.Width) + ((this.Columns - 1) * this.Padding);
      }
    }
    public int ChartWidthWithMargins {
      get {
        return this.ChartWidth + this.MinLeftMargin + this.MinRightMargin;
      }
    }
    public int ChartHeight {
      get {
        return (this.Rows * _seatSpotSize.Height) + ((this.Rows - 1) * this.Padding);
      }
    }
    public int ChartHeightWithMargins {
      get {
        return this.ChartHeight + this.TopMargin + this.MinBottomMargin;
      }
    }
    public string YearAndSeason {
      get {
        return this.Year.ToString() + "-" + this.Season.ToString();
      }
    }
    public string SeasonAndYearDisplayInParens {
      get {
        return "(" + this.Season.ToString() + " " + this.Year.ToString() + ")";
      }
    }
