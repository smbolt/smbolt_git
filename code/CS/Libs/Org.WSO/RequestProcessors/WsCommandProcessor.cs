  ...
  public class WsCommandProcessor : RequestProcessorBase, IRequestProcessor
  {
    ...
    public override XElement ProcessRequest()
    {
      try
      {
        ...
        WsCommandRequest commandRequest = new WsCommandRequest();
        ...
        //temp*** delete later
        if (commandRequest.WsCommandSet[0].Message.IsNotBlank())
        {
          string[] parse = commandRequest.WsCommandSet[0].Message.Split('.');
          commandRequest.WsCommandSet[0].Parms.Add(parse[0], parse[1]);
        }
        //commandRequest.WsCommandSet[0].Parms.Add("WebSiteName", commandRequest.WsCommandSet[0].Message);
