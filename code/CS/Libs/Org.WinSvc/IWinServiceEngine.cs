...
namespace Org.WinSvc
{
  public interface IWinServiceEngine
  {
    ...
    bool RefreshTaskRequests {
      get;
      set;
    }
    TaskRequestSet TaskRequests {
      get;
      set;
    }
    int TasksProcessed {
    ...
    Dictionary<string, string> OverrideParms {
      get;
      set;
    }
    EngineMonitorParms EngineMonitorParms {
      get;
      set;
    }
