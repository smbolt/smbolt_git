...
namespace Org.BMR.ApiModels
{
  public class ResumeModel : ApiModelBase
  {
    ...
    public string DateCreated {
      get {
        return this.CreatedDateTime.ToString("MM/dd/yyyy");
      }
    }
    ...
    public string DateUpdated {
      get {
        return (this.ModifiedDateTime.HasValue ? this.ModifiedDateTime.Value.ToString("MM/dd/yyyy") : "");
      }
    }
    ...
    public List<string> NextActionList {
      get;
      set;
    }
