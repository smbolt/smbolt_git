...
namespace Org.TSK.Business.Models
{
  public class ScheduledRunSet : SortedList<DateTime, ScheduledRun>
  {
    ...
    public string GetReport()
    {
      ...
      {
        count++;
        string scheduleElementNumber = "0000";
        if (entry.Value.TaskScheduleElement.ElementNumber.HasValue)
          scheduleElementNumber = entry.Value.TaskScheduleElement.ElementNumber.Value.ToString("0000");
