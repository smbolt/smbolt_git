...
namespace Org.BMR.Data.Entities
{
  ...
  public partial class BmrEntities : DbContext
  {
    public BmrEntities(string connectionStringName)
    ...
    public virtual DbSet<Resume> Resumes {
      get;
      set;
    }
    public virtual DbSet<ResumeStatu> ResumeStatus {
      get;
      set;
    }
    ...
    public virtual DbSet<AppLogEntity> AppLogEntities {
      get;
      set;
    }
    ...
    public virtual int sp_CheckAccountNameAvailabilityForOrg(Nullable<int> orgId, string accountName, ObjectParameter result)
    {
      ...
      return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_CheckAccountNameAvailabilityForOrg", orgIdParameter, accountNameParameter, result);
    }

    public virtual int ins_AppLog(Nullable<System.DateTime> logDateTime, Nullable<int> severityCodeId, string severityCode, string message, Nullable<int> moduleCode, Nullable<int> eventCode, string sessionId, Nullable<int> orgId, Nullable<int> accountId, Nullable<int> entityTypeId, Nullable<int> entityId, string userName, ObjectParameter logId)
    {
      ...
      var severityCodeIdParameter = severityCodeId.HasValue ?
                                    new ObjectParameter("SeverityCodeId", severityCodeId) :
                                    new ObjectParameter("SeverityCodeId", typeof(int));

      var severityCodeParameter = severityCode != null ?
                                  new ObjectParameter("SeverityCode", severityCode) :
                                  new ObjectParameter("SeverityCode", typeof(string));
      ...
      return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ins_AppLog", logDateTimeParameter, severityCodeIdParameter, severityCodeParameter, messageParameter, moduleCodeParameter, eventCodeParameter, sessionIdParameter, orgIdParameter, accountIdParameter, entityTypeIdParameter, entityIdParameter, userNameParameter, logId);
    }

    public virtual int ins_AppLogDetail(Nullable<int> logId, Nullable<int> setId, string appLogDetailTypeCode, string logDetail, ObjectParameter logDetailId)
    {
      ...
      var appLogDetailTypeCodeParameter = appLogDetailTypeCode != null ?
                                          new ObjectParameter("AppLogDetailTypeCode", appLogDetailTypeCode) :
                                          new ObjectParameter("AppLogDetailTypeCode", typeof(string));

      var logDetailParameter = logDetail != null ?
                               new ObjectParameter("LogDetail", logDetail) :
                               new ObjectParameter("LogDetail", typeof(string));

      return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ins_AppLogDetail", logIdParameter, setIdParameter, appLogDetailTypeCodeParameter, logDetailParameter, logDetailId);
    }
  }
}
