...
namespace Org.PdfExtractToolWindows
{
  public partial class TextExtractDesigner : ToolPanelBase
  {
    ...
    private void Reprocess()
    {
      ...
      {
        this.Cursor = Cursors.Default;
				var fCxExceptionDisplay = new frmCxExceptionDisplay(cx);
				fCxExceptionDisplay.ShowDialog();
      }
      catch (Exception ex)
      {
        this.Cursor = Cursors.Default;
    ...
    private void RefreshViews()
    {
      ...
      else
      {
		...
		{
			Org.GS.TextProcessing.Text.BreakpointEnabled = breakpointEnabled;
			Org.GS.TextProcessing.Text.KeepBreakpointEnabled = keepBreakpointsEnabled;
		}
