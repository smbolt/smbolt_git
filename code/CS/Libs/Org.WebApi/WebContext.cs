...
namespace Org.WebApi
{
  public class WebContext
  {
    ...
    public WebContext(RequestContext requestContext, System.Net.Http.HttpRequestMessage httpRequestMessage)
    {
    ...
    private HttpContextWrapper Get_HttpContext()
    {
      if (this.HttpControllerContext == null)
      {
        ...
        if (_httpRequestMessage.Properties.ContainsKey("MS_HttpContext"))
        {
          return _httpRequestMessage.Properties["MS_HttpContext"] as HttpContextWrapper;
        }
      }
