...
namespace Org.FM
{
  public class FileMgmtEngine : WinServiceEngineBase
  {
      ...
      : base(winServiceParms, "FileMgmtEngine")
    {
      ...
      StartupLogging.WriteStartupLog("FileMgmtService starting up - at start of " + base.EngineName + " constructor");
    ...
    public override bool Start()
    {
      try
      {
        ...
        base.TaskDispatcher = new FileMgmtTaskDispatcher();
    ...
    private void Initialize()
    {
      ...
      try
      {
        ...
        {
          // do stuff specific to the functionality of the FileMgmtEngine
        }
