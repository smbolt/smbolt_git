...
namespace Org.Cfg.Messaging
{
  public class MessageHeader
  {
    ...
    public MessageDateTime SenderSendDateTime {
      get;
      set;
    }
    public MessageDateTime ReceiverReceiveDateTime {
      get;
      set;
    }
    public MessageDateTime ReceiverRespondDateTime {
      get;
      set;
    }
    public MessageDateTime SenderReceiveDateTime {
      get;
      set;
    }
    public DateTime? SenderSendLocalDateTime {
      get {
        return this.SenderSendDateTime.ToLocalDateTime();
      }
    }
    public DateTime? ReceiverReceiveLocalDateTime {
      get {
        return this.ReceiverReceiveDateTime.ToLocalDateTime();
      }
    }
    public DateTime? ReceiverRespondLocalDateTime {
      get {
        return this.ReceiverRespondDateTime.ToLocalDateTime();
      }
    }
    public DateTime? SenderReceiveLocalDateTime {
      get {
        return this.SenderReceiveDateTime.ToLocalDateTime();
      }
    }
    public TimeSpan? TotalResponseTime {
      get {
        return (TimeSpan?)null;  // implement this
      }
    }
    ...
    public PerformanceInfoSet PerformanceInfoSet {
      get;
      set;
    }
