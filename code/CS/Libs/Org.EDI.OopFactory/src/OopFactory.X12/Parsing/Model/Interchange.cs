...
namespace OopFactory.X12.Parsing.Model
{
  public class Interchange : Container, IXmlSerializable
  {
    ...
    public string AuthorInfoQualifier
    {
      ...
      set {
        SetElement(1, String.Format("{0,-2}", value));
      }
    }
    ...
    public string AuthorInfo
    {
      ...
      set {
        SetElement(2, String.Format("{0,-10}", value));
      }
    }
    ...
    public string SecurityInfoQualifier
    {
      ...
      set {
        SetElement(3, String.Format("{0,-2}", value));
      }
    }
    ...
    public string SecurityInfo
    {
      ...
      set {
        SetElement(4, String.Format("{0,-10}", value));
      }
    }
    ...
    public string InterchangeSenderIdQualifier
    {
      ...
      set {
        SetElement(5, String.Format("{0,-2}", value));
      }
    }
    ...
    public string InterchangeReceiverIdQualifier
    {
      ...
      set {
        SetElement(7, String.Format("{0,-2}", value));
      }
    }
