...
namespace OopFactory.X12.Parsing.Model.Typed
{
  ...
  public class TypedSegmentPER : TypedSegment
  {
    ...
    private CommunicationNumberQualifer GetQualifier(int elementNumber)
    {
      ...
      {
        case "EM":
          return CommunicationNumberQualifer.ElectronicMail;
        case "EX":
          return CommunicationNumberQualifer.TelephoneExtension;
        case "FX":
          return CommunicationNumberQualifer.Facsimile;
        case "TE":
          return CommunicationNumberQualifer.Telephone;
        default:
          return CommunicationNumberQualifer.Undefined;
      }
    }
    ...
    private void SetQualifier(int elementNumber, CommunicationNumberQualifer value)
    {
      switch (value)
      {
        case CommunicationNumberQualifer.ElectronicMail:
          _segment.SetElement(elementNumber, "EM");
          break;
        case CommunicationNumberQualifer.TelephoneExtension:
          _segment.SetElement(elementNumber, "EX");
          break;
        case CommunicationNumberQualifer.Facsimile:
          _segment.SetElement(elementNumber, "FX");
          break;
        case CommunicationNumberQualifer.Telephone:
          _segment.SetElement(elementNumber, "TE");
          break;
        default:
          _segment.SetElement(elementNumber, "");
          break;
      }
    }
    ...
    {
      get {
        return GetQualifier(5);
      }
      set {
        SetQualifier(5, value);
      }
    }
    ...
    {
      get {
        return GetQualifier(7);
      }
      set {
        SetQualifier(7, value);
      }
    }
