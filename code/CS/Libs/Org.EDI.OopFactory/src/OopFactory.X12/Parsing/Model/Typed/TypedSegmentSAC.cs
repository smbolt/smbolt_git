...
namespace OopFactory.X12.Parsing.Model.Typed
{
  ...
  public class TypedSegmentSAC : TypedSegment
  {
    ...
    {
      get {
        return _segment.GetElement(1).ToEnumFromEDIFieldValue<AllowanceOrChargeIndicator>();
      }
      set {
    ...
    public int? SAC05_AmountN2
    {
      ...
      set {
        _segment.SetElement(5, string.Format("{0}", value));
      }
    }
    ...
    {
      get {
        return _segment.GetElement(16);
      }
      set {
        _segment.SetElement(16, value);
      }
    }
  }
}
