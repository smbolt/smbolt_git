...
namespace OopFactory.X12.Parsing.Specification
{
  public class ElementSpecification
  {
    ...
    [XmlAttribute]
    public ElementDataTypeEnum Type {
      get;
      set;
    }
    [XmlAttribute]
    public int ImpliedDecimalPlaces {
      get;
      set;
    }
    [XmlAttribute]
    ...
    [XmlAttribute]
    public bool AllowedListInclusive {
      get;
      set;
    }
    [XmlAttribute]
    public string QualifierSetRef {
      get;
      set;
    }
    [XmlAttribute]
    public string QualifierSetId {
      get;
      set;
    }

    [XmlElement(ElementName="Allowed")]
    public List<AllowedIdentifier> AllowedIdentifiers {
      get;
      set;
    }
  }
