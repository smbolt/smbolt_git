...
namespace OopFactory.X12.Parsing.Specification
{
  ...
  public class LoopSpecification : IContainerSpecification
  {
    ...
    [XmlIgnore]
    public bool LoopRepeatSpecified {
      get;
      set;
    }
    ...
    public StartingSegment StartingSegment {
      get;
      set;
    }

    [XmlElement("Segment")]
    public List<SegmentSpecification> SegmentSpecifications {
      get;
      set;
    }

    [XmlElement("Loop")]
    public List<LoopSpecification> LoopSpecifications {
      get;
      set;
    }

    [XmlElement("HierarchicalLoop")]
    public List<HierarchicalLoopSpecification> HierarchicalLoopSpecifications {
      get;
      set;
    }
  }
