...
namespace OopFactory.X12.Hipaa.Claims
{
  public class ServiceLine
  {
    ...
    [XmlAttribute]
    public string PurchasedServiceIdentifier {
      get;  // NPI
      set;
    }
    [XmlAttribute]
    public string PurchasedServiceAmount {
      get;
      set;
    }
    ...
    {
      get {
        return NonCoveredChargeAmount ?? decimal.Zero;
      }
      set {
        NonCoveredChargeAmount = value;
      }
    }
    ...
    {
      get {
        return NonCoveredChargeAmount.HasValue;
      }
      set { }
    }
    ...
    public DrugIdentification Drug {
      get;
      set;
    }

    [XmlElement(ElementName="SupplementalInformation")]
    public List<Paperwork> SupplementalInformations {
      get;
      set;
    }
    ...
    public List<LineAdjustmentInformation> LineAdjustmentInformations {
      get;
      set;
    }
    ...
    public Provider PurchasedServiceProvider {
      get {
        return Providers.FirstOrDefault(p => p.Name.Type.Identifier == "QB");
      }
    }
    public Provider ServiceFacilityLocation {
      get {
        return Providers.FirstOrDefault(p => p.Name.Type.Identifier == "77");
      }
    }
    public Provider SupervisingProvider {
      get {
        return Providers.FirstOrDefault(p => p.Name.Type.Identifier == "DQ");
      }
    }

    public Provider OrderingProvider {
      get {
        return Providers.FirstOrDefault(p => p.Name.Type.Identifier == "DK");
      }
    }
    public Provider AmbulancePickupLocation {
      get {
        return Providers.FirstOrDefault(p => p.Name.Type.Identifier == "PW");
      }
    }
    public Provider AmbulanceDropoffLocation {
      get {
        return Providers.FirstOrDefault(p => p.Name.Type.Identifier == "45");
      }
    }

    [XmlElement(ElementName = "OralCavityDesignation")]
    public List<Common.Lookup> OralCavityDesignations {
      get;
      set;
    }

    [XmlElement(ElementName = "ToothInformation")]
    public List<ToothInformation> ToothInformations {
      get;
      set;
    }
  }
