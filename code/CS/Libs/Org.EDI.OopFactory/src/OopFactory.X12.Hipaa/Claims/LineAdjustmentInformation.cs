...
namespace OopFactory.X12.Hipaa.Claims
{
  public class LineAdjustmentInformation
  {
    ...
    [XmlAttribute]
    public string OtherPayerPrimaryIdentifier {
      get;
      set;
    }

    [XmlAttribute]
    public decimal ServiceLinePaidAmount {
      get;
      set;
    }

    [XmlAttribute]
    public decimal PaidServiceUnitCount {
      get;
      set;
    }

    [XmlIgnore]
    public bool PaidServiceUnitCountSpecified {
      get;
      set;
    }

    [XmlAttribute]
    public string BundledLineNumber {
      get;
      set;
    }
    ...
    public List<ClaimsAdjustment> Adjustments {
      get;
      set;
    }
