...
namespace OopFactory.X12.Hipaa.Eligibility
{
  public class EligibilityBenefitInformation
  {
    ...
    {
      get {
        return Percentage ?? decimal.Zero;
      }
      set {
        Percentage = value;
      }
    ...
    public Lookup InfoType {
      get;
      set;
    }
    public Lookup CoverageLevel {
      get;
      set;
    }

    [XmlElement(ElementName="ServiceType")]
    public List<Lookup> ServiceTypes {
      get;
      set;
    }

    public Lookup InsuranceType {
      get;
      set;
    }
    ...
    public Lookup TimePeriod {
      get;
      set;
    }
    public QualifiedAmount Quantity {
      get;
      set;
    }
    public Lookup InPlanNetwork {
      get;
      set;
    }
    public Lookup AuthorizationCertificationRequired {
      get;
      set;
    }
    ...
    public List<RequestValidation> RequestValidations {
      get;
      set;
    }
    ...
    public List<EligibilityBenefitAdditionalInformation> AdditionalInfos {
      get;
      set;
    }
