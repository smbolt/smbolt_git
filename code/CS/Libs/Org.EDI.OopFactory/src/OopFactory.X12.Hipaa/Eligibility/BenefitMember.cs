...
namespace OopFactory.X12.Hipaa.Eligibility
{
  public class BenefitMember : Member
  {
    ...
    public List<Lookup> Diagnoses {
      get;
      set;
    }

    [XmlElement(ElementName = "RequestValidation")]
    public new List<RequestValidation> RequestValidations {
      get;
      set;
    }
    ...
    {
      get {
        return PlanDate ?? DateTime.MinValue;
      }
      set { }
    }
    ...
    {
      get {
        return PlanBeginDate ?? DateTime.MinValue;
      }
      set { }
    }
    ...
    {
      get {
        return PlanEndDate ?? DateTime.MinValue;
      }
      set { }
    }
    ...
    {
      get {
        return EligibilityDate ?? DateTime.MinValue;
      }
      set { }
    }
    ...
    {
      get {
        return EligibilityDate.HasValue;
      }
      set { }
    }
    #endregion
    ...
    {
      get {
        return EligibilityBeginDate ?? DateTime.MinValue;
      }
      set { }
    }
    ...
    {
      get {
        return EligibilityBeginDate.HasValue;
      }
      set { }
    }
    #endregion
    ...
    {
      get {
        return EligibilityEndDate ?? DateTime.MinValue;
      }
      set { }
    }
    ...
    {
      get {
        return EligibilityEndDate.HasValue;
      }
      set { }
    }
    #endregion
