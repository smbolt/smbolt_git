...
namespace Org.GS.OrgScript.Compilation
{
  public class SyntaxNode
  {
    ...
    public int Length { get { return this.RawText.Length; } }
    public int BeginPos { get; set; }
    public int EndPos { get; set; }
    public int LineNumber { get; set; }
    public SyntaxNodeType SyntaxNodeType { get; private set; }

    public SyntaxNodeSet SyntaxNodeSet { get; private set; }
