...
namespace Org.GS
{
  ...
  public class Parm
  {
    ...
    {
      var clone = new Parm();
      clone.ParameterId = this.ParameterId;
      clone.ScheduledTaskId = this.ScheduledTaskId;
      clone.ParameterSetName = this.ParameterSetName;
      clone.ParameterName = this.ParameterName;
      clone.ParameterValue = this.ParameterValue;
      clone.ParameterType = this.ParameterType;
      clone.RemoveThisParm = this.RemoveThisParm;
      return clone;
    }
  }
}
