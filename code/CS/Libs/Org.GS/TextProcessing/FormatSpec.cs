...
namespace Org.GS.TextProcessing
{
  ...
  public class FormatSpec
  {
    ...
    [XMap(XType = XType.Element)]
    public TextStructureDefinition TextStructureDefinition { get; set; }
    ...
    public FormatSpec()
    {
      ...
      this.IsActive = true;
      this.RecogSpecSet = new RecogSpecSet();
      this.TextStructureDefinition = new TextStructureDefinition();
    }
    ...
    public bool IsMatch(string text)
    {
      ...
      foreach (var recogSpec in this.RecogSpecSet.Values)
      {
        ...
        foreach (var recogLine in recogSpec.RecogLineSet)
        {
          ...
          {
            int idx = text.IndexOf(recogLine.Text, prevIdx);
