    ...
    private string Get_TaskReport()
    {
      ...
      if (Monitor.TryEnter(TaskRequestSet_LockObject, 1000))
      {
        try
        {
          ...
          sb.Append("Report of Tasks Scheduled" + g.crlf);
          ...
          sb.Append("Next update of the task request list is scheduled for " + this.NextLoadTime.ToString("yyyy-MM-dd HH:mm:ss") + g.crlf);
