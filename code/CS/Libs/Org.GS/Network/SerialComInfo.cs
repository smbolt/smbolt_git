...
namespace Org.GS.Network
{
  public class SerialComInfo
  {
    ...
    public UInt32 StopBits { get; set; } 
    public bool Support16BitMode { get; set; } 
    public bool SupportDTRDSR { get; set; } 
    public bool SupportIntervalTimeouts { get; set; } 
    public bool SupportParityCheck { get; set; } 
    public bool SupportRTSCTS { get; set; } 
    public bool SupportXonXoff { get; set; } 
    ...
    public UInt32 dwCurrentRxQueue { get; set; } 
    public UInt32 dwCurrentTxQueue { get; set; } 
    public UInt32 dwMaxBaud { get; set; } 
    public UInt32 dwMaxRxQueue { get; set; } 
    public UInt32 dwMaxTxQueue { get; set; } 
    public UInt32 dwProvCapabilities { get; set; } 
    public UInt32 dwProvCharSize { get; set; } 
    public UInt32 dwProvSpec1 { get; set; } 
    public UInt32 dwProvSpec2 { get; set; } 
    public UInt32 dwProvSubType { get; set; } 
    public UInt32 dwReserved1 { get; set; } 
    public UInt32 dwServiceMask { get; set; } 
    public UInt32 dwSettableBaud { get; set; } 
    public UInt32 dwSettableParams { get; set; } 
    public Byte wcProvChar { get; set; } 
    public UInt16 wPacketLength { get; set; } 
    public UInt16 wPacketVersion { get; set; } 
    public UInt16 wSettableData { get; set; } 
    public UInt16 wSettableStopParity { get; set; } 

    // MSSerial_HardwareConfiguration
    public UInt64 BaseIOAddress { get; set; } 
    public UInt32 InterruptType { get; set; } 
    public UInt64 IrqAffinityMask { get; set; } 
    public UInt32 IrqLevel { get; set; } 
    public UInt32 IrqNumber { get; set; } 
    public UInt32 IrqVector { get; set; } 

    // MSSerial_PerformanceInformation
    public UInt32 BufferOverrunErrorCount { get; set; }
    public UInt32 FrameErrorCount { get; set; }
    public UInt32 ParityErrorCount { get; set; }
    public UInt32 ReceivedCount { get; set; }
    public UInt32 SerialOverrunErrorCount { get; set; }
    public UInt32 TransmittedCount { get; set; }

    // PnPEntity_Information
    public bool PnP_InfoFound { get; set; }
    public UInt16 PnP_Availability { get; set; }
    public string PnP_Caption { get; set; }
    public string PnP_ClassGuid  { get; set; }
    public string[] PnP_CompatibleID { get; set; }
    public UInt32 PnP_ConfigManagerErrorCode { get; set; }
    public bool PnP_ConfigManagerUserConfig { get; set; }
    public string PnP_CreationClassName { get; set; }
    public string PnP_Description { get; set; }
    public string PnP_DeviceID { get; set; }
    public bool PnP_ErrorCleared { get; set; }
    public string PnP_ErrorDescription { get; set; }
    public string[] PnP_HardwareID { get; set; }
    public DateTime? PnP_InstallDate { get; set; }
    public UInt32 PnP_LastErrorCode { get; set; }
    public string PnP_Manufacturer { get; set; }
    public string PnP_Name { get; set; }
    public string PnP_PNPDeviceID { get; set; }
    public UInt16[] PnP_PowerManagementCapabilities { get; set; }
    public bool PnP_PowerManagementSupported { get; set; }
    public string PnP_Service { get; set; }
    public string PnP_Status { get; set; }
    public UInt16 PnP_StatusInfo { get; set; }
    public string PnP_SystemCreationClassName { get; set; }
    public string PnP_SystemName { get; set; }

    public string FormattedDevice
    {
      get { return Get_FormattedDevice(); }
    }

    public string DeviceIdentifier
    {
      get { return Get_DeviceIdentifier(); }
    }

    public string Manufacturer
    {
      get { return this.PnP_Manufacturer; }
    }

    public string Product
    {
      get { return this.PnP_Name; }
    }
