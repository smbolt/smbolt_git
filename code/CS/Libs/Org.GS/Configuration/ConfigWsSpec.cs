...
namespace Org.GS.Configuration
{
  ...
  public class ConfigWsSpec : ConfigObjectBase
  {
    ...
    [OrgConfigItem] public WebServiceBinding WsBinding {
      get;
      set;
    }
    [OrgConfigItem] public string WsHost {
      get;
      set;
    }
    [OrgConfigItem] public string WsPort {
      get;
      set;
    }
    [OrgConfigItem] public string WsServiceName {
      get;
      set;
    }

    public WebServiceBinding VerifiedWsBinding {
      get;
      set;
    }
    public string VerifiedWsHost {
      get;
      set;
    }
    public string VerifiedWsPort {
      get;
      set;
    }
    public string VerifiedWsServiceName {
      get;
      set;
    }

    public WebServiceBinding OriginalWsBinding {
      get;
      set;
    }
    public string OriginalWsHost {
      get;
      set;
    }
    public string OriginalWsPort {
      get;
      set;
    }
    public string OriginalWsServiceName {
      get;
      set;
    }

    public bool WebSvcSpecVerified {
      get;
      set;
    }
    public bool SkipWebSvcSpecConfig {
      get;
      set;
    }
