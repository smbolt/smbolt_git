...
namespace Org.GS
{
  public class HtmlToText
  {
    ...
    public string Convert(string html)
    {
      ...
      string rawReturnValue = System.Web.HttpUtility.HtmlDecode(_text.ToString());
      string returnValue = rawReturnValue.Replace("\r\n", " \r\n");
      return returnValue;
    }
    ...
    {
      _pos = System.Math.Min(_pos + 1, _html.Length);
    }
