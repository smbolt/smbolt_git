...
namespace Org.GS
{
    ...
    {
        public DateTime OperationBeginDT { get; set; }
        public DateTime OperationEndDT { get; set; }
        public DateTime SegmentCreateDT { get; set; }
        public string SourceFileFullPath { get; set; }
        public int OriginalFullFileLength { get; set; }
        public int FullBase64Length { get; set; }
