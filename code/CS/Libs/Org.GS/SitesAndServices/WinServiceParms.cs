...
namespace Org.GS
{
  public class WinServiceParms
  {
    ...
    public bool IsRunningAsWindowsService {
      get;
      set;
    }
    public string ConfigLogSpecPrefix {
      get;
      set;
    }
    public string ConfigNotifySpecPrefix {
      get;
      set;
    }
    public int MaxWaitIntervalMilliseconds {
      get;
      set;
    }
    ...
    public bool SuppressNonErrorOutput {
      get;
      set;
    }
    public bool SuppressTaskReload {
      get;
      set;
    }
    ...
    public bool UseAlerter {
      get;
      set;
    }
    public string AlerterPath {
      get;
      set;
    }
